...
def map19(x_pos, y_pos, developer_mode):
    ...
    # load texture
    ground_texture = pygame.image.load(os.path.join(base_dir, 'assets/map19/ground/ground.jpg'))

    wall_texture = pygame.image.load(os.path.join(base_dir, 'assets/map19/wall/wall.png'))

    idle = pygame.image.load(os.path.join(base_dir, 'assets/map19/player/idle.png'))

    walk_up = None

    walk_left = [pygame.image.load(os.path.join(base_dir, 'assets/map19/player/L1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map19/player/L2.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map19/player/L3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map19/player/L4.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map19/player/L5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map19/player/L6.png'))]

    walk_down = None

    walk_right = [pygame.image.load(os.path.join(base_dir, 'assets/map19/player/R1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map19/player/R2.png')),
                  pygame.image.load(os.path.join(base_dir, 'assets/map19/player/R3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map19/player/R4.png')),
                  pygame.image.load(os.path.join(base_dir, 'assets/map19/player/R5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map19/player/R6.png'))]

    bot_idle = pygame.image.load(os.path.join(base_dir, 'assets/map19/bot/idle.png'))

    bot_up = None

    bot_left = [pygame.image.load(os.path.join(base_dir, 'assets/map19/bot/L1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map19/bot/L2.png')),
                pygame.image.load(os.path.join(base_dir, 'assets/map19/bot/L3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map19/bot/L4.png')),
                pygame.image.load(os.path.join(base_dir, 'assets/map19/bot/L5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map19/bot/L6.png'))]

    bot_down = None

    bot_right = [pygame.image.load(os.path.join(base_dir, 'assets/map19/bot/R1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map19/bot/R2.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map19/bot/R3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map19/bot/R4.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map19/bot/R5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map19/bot/R6.png'))]
    ...
    # - developer_mode: A flag indicating whether to enable developer-specific features
    bots = [Bot(660, 600, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(1140, 360, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode)]
    ...
    walls = [Wall(0, 0, 630, 864, wall_texture), Wall(750, 0, 786, 330, wall_texture),
             Wall(750, 450, 786, 414, wall_texture)]
    ...
    mp = [InvisibleWall(630, 0, 120, 2), InvisibleWall(1534, 330, 2, 120),
          InvisibleWall(630, 862, 120, 2)]
    ...
    while running:
        ...
        for bot in bots:
            ...
            if player.rect.colliderect(bot.rect):
                sound_effect = pygame.mixer.Sound(os.path.join(base_dir, 'assets/map19/sound/lose.wav'))
        ...
        if developer_mode:
            ...
            scaled_surface.blit(font.render(f"Developer Mode - Map19", True, (255, 0, 0)), (10, 5))
