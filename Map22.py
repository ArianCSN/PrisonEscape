...
def map22(x_pos, y_pos, developer_mode):
    ...
    # load texture
    ground_texture = pygame.image.load(os.path.join(base_dir, 'assets/map22/ground/ground.jpg'))

    wall_texture = pygame.image.load(os.path.join(base_dir, 'assets/map22/wall/wall.png'))

    idle = pygame.image.load(os.path.join(base_dir, 'assets/map22/player/idle.png'))

    walk_up = None

    walk_left = [pygame.image.load(os.path.join(base_dir, 'assets/map22/player/L1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map22/player/L2.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map22/player/L3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map22/player/L4.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map22/player/L5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map22/player/L6.png'))]

    walk_down = None

    walk_right = [pygame.image.load(os.path.join(base_dir, 'assets/map22/player/R1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map22/player/R2.png')),
                  pygame.image.load(os.path.join(base_dir, 'assets/map22/player/R3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map22/player/R4.png')),
                  pygame.image.load(os.path.join(base_dir, 'assets/map22/player/R5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map22/player/R6.png'))]

    bot_idle = pygame.image.load(os.path.join(base_dir, 'assets/map22/bot/idle.png'))

    bot_up = None

    bot_left = [pygame.image.load(os.path.join(base_dir, 'assets/map22/bot/L1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map22/bot/L2.png')),
                pygame.image.load(os.path.join(base_dir, 'assets/map22/bot/L3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map22/bot/L4.png')),
                pygame.image.load(os.path.join(base_dir, 'assets/map22/bot/L5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map22/bot/L6.png'))]

    bot_down = None

    bot_right = [pygame.image.load(os.path.join(base_dir, 'assets/map22/bot/R1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map22/bot/R2.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map22/bot/R3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map22/bot/R4.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map22/bot/R5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map22/bot/R6.png'))]
    ...
    # - developer_mode: A flag indicating whether to enable developer-specific features
    bots = [Bot(300, 390, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(720, 660, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(1372, 619, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode)]
    ...
    while running:
        ...
        if player.rect.colliderect(tps[0]):
            ...
            sound_effect = pygame.mixer.Sound(os.path.join(base_dir, 'assets/map22/sound/teleport.wav'))
        ...
        for bot in bots:
            ...
            if player.rect.colliderect(bot.rect):
                sound_effect = pygame.mixer.Sound(os.path.join(base_dir, 'assets/map22/sound/lose.wav'))
                sound_effect.set_volume(0.2)
                sound_effect.play()
        ...
        if developer_mode:
            ...
            scaled_surface.blit(font.render(f"Developer Mode - Map22", True, (255, 0, 0)), (10, 5))
