...
def map20(x_pos, y_pos, developer_mode):
    ...
    bots = [Bot(300, 420, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(480, 210, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(480, 630, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(720, 210, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(750, 510, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(980, 240, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(1080, 630, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(1260, 300, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(1290, 660, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode)]
    ...
    while running:
        ...
        if developer_mode:
            ...
            scaled_surface.blit(font.render(f"Developer Mode - Map20", True, (255, 0, 0)), (10, 5))
