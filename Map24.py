...
def map24(x_pos, y_pos, developer_mode):
    ...
    # load texture
    ground_texture = pygame.image.load(os.path.join(base_dir, 'assets/map24/ground/ground.jpg'))

    wall_texture = pygame.image.load(os.path.join(base_dir, 'assets/map24/wall/wall.png'))

    idle = pygame.image.load(os.path.join(base_dir, 'assets/map24/player/idle.png'))

    walk_up = None

    walk_left = [pygame.image.load(os.path.join(base_dir, 'assets/map24/player/L1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map24/player/L2.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map24/player/L3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map24/player/L4.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map24/player/L5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map24/player/L6.png'))]

    walk_down = None

    walk_right = [pygame.image.load(os.path.join(base_dir, 'assets/map24/player/R1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map24/player/R2.png')),
                  pygame.image.load(os.path.join(base_dir, 'assets/map24/player/R3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map24/player/R4.png')),
                  pygame.image.load(os.path.join(base_dir, 'assets/map24/player/R5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map24/player/R6.png'))]

    bot_idle = pygame.image.load(os.path.join(base_dir, 'assets/map24/bot/idle.png'))

    bot_up = None

    bot_left = [pygame.image.load(os.path.join(base_dir, 'assets/map24/bot/L1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map24/bot/L2.png')),
                pygame.image.load(os.path.join(base_dir, 'assets/map24/bot/L3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map24/bot/L4.png')),
                pygame.image.load(os.path.join(base_dir, 'assets/map24/bot/L5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map24/bot/L6.png'))]

    bot_down = None

    bot_right = [pygame.image.load(os.path.join(base_dir, 'assets/map24/bot/R1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map24/bot/R2.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map24/bot/R3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map24/bot/R4.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map24/bot/R5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map24/bot/R6.png'))]
    ...
    while running:
        ...
        if player.rect.colliderect(tps[0]):
            ...
            sound_effect = pygame.mixer.Sound(os.path.join(base_dir, 'assets/map24/sound/teleport.wav'))
        ...
        for bot in bots:
            ...
            if player.rect.colliderect(bot.rect):
                sound_effect = pygame.mixer.Sound(os.path.join(base_dir, 'assets/map24/sound/lose.wav'))
                sound_effect.set_volume(0.2)
                sound_effect.play()
