...
def map06(x_pos, y_pos, developer_mode):
    ...
    # load texture
    ground_texture = pygame.image.load(os.path.join(base_dir, 'assets/map06/ground/ground.jpg'))

    wall_texture = pygame.image.load(os.path.join(base_dir, 'assets/map06/wall/wall.png'))

    idle = pygame.image.load(os.path.join(base_dir, 'assets/map06/player/idle.png'))

    walk_up = None

    walk_left = [pygame.image.load(os.path.join(base_dir, 'assets/map06/player/L1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map06/player/L2.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map06/player/L3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map06/player/L4.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map06/player/L5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map06/player/L6.png'))]

    walk_down = None

    walk_right = [pygame.image.load(os.path.join(base_dir, 'assets/map06/player/R1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map06/player/R2.png')),
                  pygame.image.load(os.path.join(base_dir, 'assets/map06/player/R3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map06/player/R4.png')),
                  pygame.image.load(os.path.join(base_dir, 'assets/map06/player/R5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map06/player/R6.png'))]

    bot_idle = None

    bot_up = None

    bot_left = [pygame.image.load(os.path.join(base_dir, 'assets/map06/bot/L1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map06/bot/L2.png')),
                pygame.image.load(os.path.join(base_dir, 'assets/map06/bot/L3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map06/bot/L4.png')),
                pygame.image.load(os.path.join(base_dir, 'assets/map06/bot/L5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map06/bot/L6.png'))]

    bot_down = None

    bot_right = [pygame.image.load(os.path.join(base_dir, 'assets/map06/bot/R1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map06/bot/R2.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map06/bot/R3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map06/bot/R4.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map06/bot/R5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map06/bot/R6.png'))]
    ...
    while running:
        ...
        for button in buttons:
            ...
            if player.rect.colliderect(button):
                ...
                if Temp_Wall:
                    sound_effect = pygame.mixer.Sound(os.path.join(base_dir, 'assets/map06/sound/open.wav'))
        ...
        for bot in bots:
            ...
            if player.rect.colliderect(bot.rect):
                sound_effect = pygame.mixer.Sound(os.path.join(base_dir, 'assets/map06/sound/lose.wav'))
