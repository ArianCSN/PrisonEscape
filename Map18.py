...
def map18(x_pos, y_pos, developer_mode):
    ...
    # load texture
    ground_texture = pygame.image.load('assets/map18/ground/ground.jpg')

    wall_texture = pygame.image.load('assets/map18/wall/wall.png')

    idle = pygame.image.load('assets/map18/player/idle.png')

    walk_up = None

    walk_left = [pygame.image.load('assets/map18/player/L1.png'), pygame.image.load('assets/map18/player/L2.png'),
                 pygame.image.load('assets/map18/player/L3.png'), pygame.image.load('assets/map18/player/L4.png'),
                 pygame.image.load('assets/map18/player/L5.png'), pygame.image.load('assets/map18/player/L6.png')]

    walk_down = None

    walk_right = [pygame.image.load('assets/map18/player/R1.png'), pygame.image.load('assets/map18/player/R2.png'),
                  pygame.image.load('assets/map18/player/R3.png'), pygame.image.load('assets/map18/player/R4.png'),
                  pygame.image.load('assets/map18/player/R5.png'), pygame.image.load('assets/map18/player/R6.png')]

    bot_idle = pygame.image.load('assets/map18/bot/idle.png')

    bot_up = None

    bot_left = [pygame.image.load('assets/map18/bot/L1.png'), pygame.image.load('assets/map18/bot/L2.png'),
                pygame.image.load('assets/map18/bot/L3.png'), pygame.image.load('assets/map18/bot/L4.png'),
                pygame.image.load('assets/map18/bot/L5.png'),pygame.image.load('assets/map18/bot/L6.png')]

    bot_down = None

    bot_right = [pygame.image.load('assets/map18/bot/R1.png'), pygame.image.load('assets/map18/bot/R2.png'),
                 pygame.image.load('assets/map18/bot/R3.png'), pygame.image.load('assets/map18/bot/R4.png'),
                 pygame.image.load('assets/map18/bot/R5.png'),pygame.image.load('assets/map18/bot/R6.png')]
    ...
    while running:
        ...
        for bot in bots:
            ...
            if player.rect.colliderect(bot.rect):
                sound_effect = pygame.mixer.Sound('assets/map18/sound/lose.wav')
