...
def map18(x_pos, y_pos, developer_mode):
    ...
    # load texture
    ground_texture = pygame.image.load(os.path.join(base_dir, 'assets/map18/ground/ground.jpg'))

    wall_texture = pygame.image.load(os.path.join(base_dir, 'assets/map18/wall/wall.png'))

    idle = pygame.image.load(os.path.join(base_dir, 'assets/map18/player/idle.png'))

    walk_up = None

    walk_left = [pygame.image.load(os.path.join(base_dir, 'assets/map18/player/L1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map18/player/L2.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map18/player/L3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map18/player/L4.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map18/player/L5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map18/player/L6.png'))]

    walk_down = None

    walk_right = [pygame.image.load(os.path.join(base_dir, 'assets/map18/player/R1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map18/player/R2.png')),
                  pygame.image.load(os.path.join(base_dir, 'assets/map18/player/R3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map18/player/R4.png')),
                  pygame.image.load(os.path.join(base_dir, 'assets/map18/player/R5.png')), pygame.image.load(os.path.join(base_dir, 'assets/map18/player/R6.png'))]

    bot_idle = pygame.image.load(os.path.join(base_dir, 'assets/map18/bot/idle.png'))

    bot_up = None

    bot_left = [pygame.image.load(os.path.join(base_dir, 'assets/map18/bot/L1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map18/bot/L2.png')),
                pygame.image.load(os.path.join(base_dir, 'assets/map18/bot/L3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map18/bot/L4.png')),
                pygame.image.load(os.path.join(base_dir, 'assets/map18/bot/L5.png')),pygame.image.load(os.path.join(base_dir, 'assets/map18/bot/L6.png'))]

    bot_down = None

    bot_right = [pygame.image.load(os.path.join(base_dir, 'assets/map18/bot/R1.png')), pygame.image.load(os.path.join(base_dir, 'assets/map18/bot/R2.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map18/bot/R3.png')), pygame.image.load(os.path.join(base_dir, 'assets/map18/bot/R4.png')),
                 pygame.image.load(os.path.join(base_dir, 'assets/map18/bot/R5.png')),pygame.image.load(os.path.join(base_dir, 'assets/map18/bot/R6.png'))]
    ...
    # - developer_mode: A flag indicating whether to enable developer-specific features
    bots = [Bot(300, 420, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(450, 330, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(660, 420, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(900, 360, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(1140, 450, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(1230, 360, scaled_surface, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode)]
    ...
    walls = [Wall(0, 0, 1536, 300, wall_texture), Wall(0, 510, 1536, 354, wall_texture)]
    ...
    mp = [InvisibleWall(720, 298, 90, 2), InvisibleWall(1534, 300, 2, 210),
          InvisibleWall(720, 510, 90, 2), InvisibleWall(0, 300, 2, 210)]
    ...
    while running:
        ...
        for bot in bots:
            ...
            if player.rect.colliderect(bot.rect):
                sound_effect = pygame.mixer.Sound(os.path.join(base_dir, 'assets/map18/sound/lose.wav'))
        ...
        if developer_mode:
            ...
            scaled_surface.blit(font.render(f"Developer Mode - Map18", True, (255, 0, 0)), (10, 5))
