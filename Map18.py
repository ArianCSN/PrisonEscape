...
def map18(x_pos, y_pos, developer_mode):
    ...
    bots = [Bot(300, 420, screen, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(450, 330, screen, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(660, 420, screen, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(900, 360, screen, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(1140, 450, screen, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode),
            Bot(1230, 360, screen, bot_up, bot_left, bot_down, bot_right, bot_idle, 2, developer_mode)]
    ...
    while running:
        ...
        if developer_mode:
            ...
            screen.blit(font.render(f"Developer Mode - map18", True, (255, 0, 0)), (10, 5))
